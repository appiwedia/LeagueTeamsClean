...
// MARK: - RequestManagerProtocol Default
/// An extension to provide a default parser for the `RequestManagerProtocol`.
public extension RequestManagerProtocol {
    
    /// The default data parser used to transform API response data into `Decodable` objects.
